...
const customerLifetimeValue = "$1,234,567";
const customerSegments = [
  { segment: "High Value", count: 120 },
  { segment: "Medium Value", count: 300 },
  { segment: "Low Value", count: 580 },
];
      ...
      <div className="h-full bg-red-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="p-6">
            ...
            <CardContent>
              <div className="text-2xl font-bold mb-2">{customerLifetimeValue}</div>
              <p className="text-xs text-muted-foreground">Total value generated by customers over their lifetime.</p>
            </CardContent>
          </Card>
